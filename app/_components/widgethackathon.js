...
export default function WidgetHackathon() {
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5 p-4 md:p-8 w-full place-items-center  md:m-10 lg:m-20">
            ...
            <div className="hidden md:flex col-span-1 w-full pl-5 pr-5 self-stretch rounded-[2rem] 
            ...
            <div className="md:hidden col-span-2 w-full rounded-[2rem] 
                bg-zinc-900/80 backdrop-blur-sm border border-white/10 
                hover:border-yellow-400/20 transition-colors
                flex items-center justify-center p-6 h-55">
                <CurrentTimeWidget />
            </div>
