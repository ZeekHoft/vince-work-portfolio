    ...
    return (
        <div >
            <div className='group pt-10'>
                <div className="  relative md:flex md:items-center bg-slate-900/40 rounded-[24px] p-6 shadow-2xl backdrop-blur-md border border-white/5 transition-all duration-500 hover:bg-slate-900/80
                hover:border-yellow-400/40  hover:shadow-[0_0_40px_rgba(250,204,21,0.1)] overflow-hidden">
                    ...
                    <div className="flex flex-col flex-grow pt-6 md:pl-10 ">
                        <h3 className="text-white text-2xl font-bold mb-4 tracking-tight group-hover:text-yellow-400">
                            {title}
                            {/* 
